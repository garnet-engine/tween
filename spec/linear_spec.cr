require "spec"
require "../src/garnet-tween/linear"

include Garnet

describe Tween::Linear do
  context "0%" do
    it "has 0% progress" do
      tween = Tween::Linear.new(1f32)
  ...
  context "25%" do
    it "has 25% progress" do
      ...
      tween.fraction.should eq(0.25f32)
    end
  end
  ...
  context "75%" do
    it "has 75% progress" do
      ...
      tween.fraction.should eq(0.75f32)
    end
  end
